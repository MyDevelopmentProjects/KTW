(function () {
    ...
    function config($stateProvider, $urlRouterProvider, MODULE_CONFIG) {
        ...
        $stateProvider
            ...
            .state('app.aboutus', {
                url: '/aboutus',
                templateUrl: '/admin/view/HAbout/index.html',
                data: {title: 'ჩვენს შესახებ'},
                controller: 'HAboutController',
                resolve: load(["admin/js/ng/controllers/HAboutController.js"])
            })
            .state('app.conference', {
                url: '/conference',
                templateUrl: '/admin/view/HConference/index.html',
                data: {title: 'კონფერენცია'},
                controller: 'HConferenceController',
                resolve: load(["admin/js/ng/controllers/HConferenceController.js"])
            })
            .state('app.restaurant', {
                url: '/restaurant',
                templateUrl: '/admin/view/HRestaurant/index.html',
                data: {title: 'რესტორანი'},
                controller: 'HRestaurantController',
                resolve: load(["admin/js/ng/controllers/HRestaurantController.js"])
            })
            .state('app.shops', {
                url: '/shops',
            ...
            .state('app.rooms', {
                url: '/rooms',
                templateUrl: '/admin/view/HRoom/index.html',
                data: {title: 'ოთახები'},
                controller: 'HRoomController',
                resolve: load(["admin/js/ng/controllers/HRoomController.js"])
            })
            .state('app.tours', {
                url: '/tours',
                templateUrl: '/admin/view/HTour/index.html',
                data: {title: 'ტურები'},
                controller: 'HTourController',
                resolve: load(["admin/js/ng/controllers/HTourController.js"])
            })
            .state('app.gallery', {
                url: '/gallery',
                templateUrl: '/admin/view/HGallery/index.html',
                data: {title: 'გალერეა'},
                controller: 'HGalleryController',
                resolve: load(["admin/js/ng/controllers/HGalleryController.js"])
            })
            .state('app.params', {
                url: '/params',
